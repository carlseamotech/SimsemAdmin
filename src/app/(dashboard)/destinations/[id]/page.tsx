...
export default function DestinationDetailsPage() {
  const { id } = useParams();
  const { destinationDetails, isLoading: detailsLoading, isError: detailsError } =
    useDestinationDetails(id as string);
  const { topCities, isLoading: citiesLoading, isError: citiesError } = useTopCities(
    id as string
  );
